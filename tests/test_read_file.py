...
def test_read_file_json(mock_s3_bucket):
    ...
    json_content = '[{"name": "Alice", "email": "alice@example.com", "age": 25}, {"name": "Bob", "email": "bob@example.com", "age": 30}]'
...
def test_read_file_parquet(mock_s3_bucket):
    ...
    data = [pa.array(["Alice", "Bob"]), pa.array(["alice@example.com", "bob@example.com"]), pa.array([25, 30])]
